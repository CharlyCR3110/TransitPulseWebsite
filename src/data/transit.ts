...
export const I18N = {
  es: {
    ...
    trip_not_found: 'No se encontró el viaje solicitado',
    trip_load_failed: 'No se pudo cargar el viaje',
    stop_not_found: 'No se encontró la parada solicitada',
  },
  en: {
    ...
    stop_not_found: 'The requested stop was not found',
  },
} as const;
