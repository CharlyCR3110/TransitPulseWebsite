...
export const I18N = {
  es: {
    ...
    schedule_only: 'Solo horario',
    predicted_eta: 'ETA prevista',
    scheduled_eta: 'Programada',
    eta_window: 'Ventana',
    routes: 'Rutas',
    routes_sub: 'Líneas con datos en vivo',
    ...
    departures: 'salidas',
    stops_label: 'Paradas',
    schedules_label: 'Horarios',
    service_weekday: 'Lunes a Viernes',
    service_saturday: 'Sábado',
    service_sunday_holiday: 'Domingo / Feriado',
    itinerary: 'Itinerario',
    start_from: 'Salir desde',
    wait_for: 'Esperar',
    ride_label: 'Viajar',
    walk_to_label: 'Caminar a',
    arrive_at: 'Llegada',
    earlier: 'Antes',
    later: 'Después',
    stops_word: 'paradas',
  ...
  en: {
    ...
    eta_window: 'Window',
    routes: 'Routes',
    routes_sub: 'Lines with live data',
    ...
    service_weekday: 'Weekdays',
    service_saturday: 'Saturday',
    service_sunday_holiday: 'Sunday / Holiday',
    itinerary: 'Itinerary',
    start_from: 'Start from',
    wait_for: 'Wait for',
    ride_label: 'Ride',
    walk_to_label: 'Walk to',
    arrive_at: 'Arrives',
    earlier: 'Earlier',
    later: 'Later',
    stops_word: 'stops',
